...
document.addEventListener('DOMContentLoaded', function() {
	...
	if (path.includes('dashboard')) {
		document.getElementById('dashboard-nav-item').classList.add('page-active');
	} else if (path.includes('postJob')) {
		document.getElementById('post-job-nav-item').classList.add('page-active');
	} else if (path.includes('gererEmplois')) {
		document.getElementById('gerer-emplois-nav-item').classList.add('page-active');
	} else if (path.includes('gererCandidats') || path.includes('candidats')) {
		document.getElementById('gerer-candiats-nav-item').classList.add('page-active');
	} else if (path.includes('dashProfile')) {
		document.getElementById('edit-profile-nav-item').classList.add('page-active');
		document.getElementById('settings').classList.add('active');
	} else if (path.includes('changePass')) {
		document.getElementById('change-password-nav-item').classList.add('page-active');
	} else if (path.includes('dashProfile')) {
		document.getElementById('edit-profile-nav-item').classList.add('page-active');
	}
});
